(function () {
    var controllerId = 'app.views.directives.formControls.buttons.removeButtonController';
    ...
    * Scopre Attributes:
    */
    app.directive('removeButtonDirective', function () {
        return {
            priority: 0,
            ...
            controllerAs: 'ctrl',
            templateUrl: '/App/Main/common/formControls/buttons/removeButtonDirective.html',    //UI for directive
