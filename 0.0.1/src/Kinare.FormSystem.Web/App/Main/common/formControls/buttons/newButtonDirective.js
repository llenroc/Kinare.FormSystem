(function () {
    var controllerId = 'app.views.directives.formControls.buttons.newButtonController';
    ...
    * Scopre Attributes:
    */
    app.directive('newButtonDirective', function () {
        return {
            priority: 0,
            ...
            controllerAs: 'ctrl',
            templateUrl: '/App/Main/common/formControls/buttons/newButtonDirective.html',    //UI for directive
